...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { country: @manufacturer.country, name: @manufacturer.name, website: @manufacturer.website }
    end
  ...
  test "should update manufacturer" do
    put :update, id: @manufacturer, manufacturer: { country: @manufacturer.country, name: @manufacturer.name, website: @manufacturer.website }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
